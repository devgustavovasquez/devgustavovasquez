...
title timeline tech
    ...
    iniciativa fis                       :active,, 2025-09-16, 2025-12-20
...
escolhi trabalhar com tecnologia porque **amo resolver problemas**.
...
é aquele que **resolve o problema** e **gera valor para o negócio**.

acredito fielmente na premissa de que não existem limitações em tech. só falta execução.

## 🧠 stack que domino

meu foco é backend, mas tenho experiência como fullstack
